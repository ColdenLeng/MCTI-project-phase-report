...
save_dir = '../results/relaxloss/HIST'
...
loss_idx = 10  # cross-entropy loss 位置
...
plt.title('Loss Distribution (RelaxLoss): Member vs Non-member', fontsize=16)
...
plt.title('Loss Histogram (RelaxLoss): Member vs Non-member', fontsize=16)
plt.legend(fontsize=12)
plt.tight_layout()
...
plt.ylim(0, clip_max)
plt.ylabel('Loss')
plt.title('Boxplot (RelaxLoss): Member vs Non-member Loss')
plt.tight_layout()
...
plt.xlabel('Loss')
plt.ylabel('Density')
plt.title('KDE (RelaxLoss): Member vs Non-member (0~0.2)')
plt.legend()
plt.tight_layout()
...
plt.ylim(0, clip_max)
plt.ylabel('Loss')
plt.title('Violin Plot (RelaxLoss): Member vs Non-member')
plt.tight_layout()

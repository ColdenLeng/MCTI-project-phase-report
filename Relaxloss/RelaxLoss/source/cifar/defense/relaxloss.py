...
def main():
    ...
    logger.set_names(['LR', 'Train CE', 'Test CE', 'Train Acc', 'Test Acc', 'Test Acc5', 'Test AUROC'])
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        test_ce, test_acc, test_acc5, test_auroc = trainer.test(model)

        for param_group in optimizer.param_groups:
            lr = param_group['lr']
        logger.append([lr, train_ce, test_ce, train_acc, test_acc, test_acc5, test_auroc])

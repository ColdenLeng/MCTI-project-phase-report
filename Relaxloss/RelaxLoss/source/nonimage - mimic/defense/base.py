...
sys.path.append(os.path.join(FILE_DIR, '../../'))
from dataset import prepare_texas, prepare_purchase, prepare_mimic
...
class NonImageTrainer(BaseTrainer):
    def set_dataloader(self):
        ...
        if self.args.dataset == 'Texas':
            ...
            target_train, target_test, shadow_train, shadow_test, pseudo_attack = prepare_mimic(self.args.random_seed)
            #demo: num_class = 10
            self.num_classes = 2
        else:
